...
`;
  ...
  function buildHeader() {
    ...
    h.dataset.siteHeader = '1';
    h.innerHTML = `<nav class="site-header__nav">
      <a class="site-header__brand" href="Главная.dc.html" aria-label="Проект-Сварка">
        <span class="site-header__brand-mark"><img src="assets/logo-mark.svg" alt="Проект-Сварка"><span class="site-header__flash"></span></span>
  ...
  function mountHeader() {
    const current = document.querySelector('header[data-site-header="1"]');
    if (current) return;
  ...
  function mountTopButton() {
    ...
    const update = () => b.classList.toggle('is-visible', window.scrollY > 180);
